...
const RESIDENCIAL_UNIDADES = ['DPTO DE BÚSQUEDA','PLAT. BELGRANO','PLAT. CABALLITO','PLAT. PALERMO','PLAT. RECOLETA','PLAT. PILAR','PLAT. BARILOCHE']
const COMERCIAL_UNIDADES = ['CONSULTORIA','LOCALES Y TERRENOS','OFICINAS Y EDIFICIOS','INDUSTRIA']
